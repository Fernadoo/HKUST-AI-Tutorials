...
\begin{columns}
    ...
    \begin{exampleblock}{In terms of memory:}
        \begin{itemize}
            \item Stimulus-response (reactive) agents,
    ...
    \pause
    \begin{exampleblock}{In terms of action function:}
        \begin{itemize}
            \item TLUs,
    ...
    \pause
    \begin{exampleblock}{In terms of optimization:}
        \begin{itemize}
...
%    \pause
%    \begin{exampleblock}{In terms of perception:}
%        \begin{itemize}
%            \item Representation, revision, ...
%        \end{itemize}  
%    \end{exampleblock}
...
\subsection{Boundary-Following Agents}

\begin{frame}{Boundary-Following Agents}
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=1\linewidth]{pic/sensor.png}
        \includegraphics[width=0.4\linewidth]{pic/bf.png}
    \end{figure}
...
\begin{frame}{Capabilities and Limitations}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.6\linewidth]{pic/eg2.png}
    \end{figure}
    \pause How many past sensory readings should the agent remember?
    \end{exampleblock}
\end{frame}

\begin{frame}{Excercise}
    \begin{exampleblock}{How about multi-agents:}
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.6\linewidth]{pic/mapf.png}
    \end{figure}
    \end{exampleblock}
\end{frame}
...
\begin{frame}{Biological description}
\begin{exampleblock}{Genetic process:}
    \begin{itemize}[<+-| alert@+>]
        \item Large enough population,

        \item Survival of the fittest,

        \item Copy and Crossover,
...
\subsection{Application in optimization}

\begin{frame}{Application in optimization}
\begin{exampleblock}{Example 3:}
Find nice optima in the interval $[-1,2]$ for the following function:
    \begin{itemize}[<+-| alert@+>]
        \item $f(x) = x \sin(10 \pi x) + 2$
        
        \item Quite complicated...
        \begin{figure}[htpb]
            \centering
            \includegraphics[width=0.7\linewidth]{pic/func.png}
        \end{figure}
    \end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{frame}{Example}
\begin{exampleblock}{Find nice optima in the interval $[-1,2]$ for the following function:}
    \begin{itemize}
        \item $f(x) = x \sin(10 \pi x) + 2$
    \end{itemize}
\end{exampleblock}
...
\pause
\begin{exampleblock}{By genetic programming:}
    \begin{itemize}[<+-| alert@+>]
        \item Initialization: randomly generate ``lots of'' 
            $$(x, f(x)), \text{representing (individual, fitness)}$$
        
        \item Repeat for enough rounds:
        \begin{itemize}[<+-| alert@+>]
            \item Crossover: $x_{child} \gets \lambda x_{father} + (1 - \lambda) x_{mother}$

            \item Mutation: $x \gets \texttt{Normal}(x, 0.5)$, for 10\% of individuals (x's)

            \item Selection: choose top 2/3 fittest individuals (x's)
        \end{itemize}
    \end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{figure}[htpb]
        \centering
        \includegraphics[width=0.4\linewidth]{pic/N_5.png}
        \includegraphics[width=0.4\linewidth]{pic/N_10.png}
        \includegraphics[width=0.4\linewidth]{pic/N_50.png}
        \includegraphics[width=0.4\linewidth]{pic/N_100.png}
        \caption{Larger population and more generations}
\end{figure}
\end{frame}


\begin{frame}{Compared to GD}
In terms of optimization, why we still need gradient descent to train
a TLU/neural network?
\begin{itemize}
    \item Genetic programming: zero-order information
    \item GD (error-correction as a special case): first-order derivatives
    \item Newton's method: second order derivatives
    (computing inverse of Hessian matrix is hard)
\end{itemize}
\end{frame}
