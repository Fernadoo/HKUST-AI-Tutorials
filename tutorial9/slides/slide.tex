...
\date{May 6\&9, 2024} % you can change it to the latest date
...
\begin{enumerate}
	...
	\pause{$$\forall x, love(Mary,x)$$}
	\item Everyone loves herself.
	\pause{$$\forall x, love(x,x)$$}
	\item Everyone loves everyone.
	\pause{$$\forall x \forall y, love(x,y)$$}
	\item Everyone loves everyone except herself.
	\pause{$$\forall x \forall y, x\neq y \implies love(x,y)$$}
\end{enumerate}
\end{frame}
...
\begin{enumerate}
	...
	\pause{$$\forall x, student(x) \land love(x,Mary) \implies happy(x)$$}
